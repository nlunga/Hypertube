...
var commentsSql = "CREATE TABLE IF NOT EXISTS comments (id INT AUTO_INCREMENT PRIMARY KEY, movieName VARCHAR(255) NOT NULL, tvSeriesName VARCHAR(255) NOT NULL, comment VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL)";
