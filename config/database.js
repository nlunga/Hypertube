...
var mediaSql = "CREATE TABLE IF NOT EXISTS mediaInfo (id INT AUTO_INCREMENT PRIMARY KEY, mediaName VARCHAR(255) NOT NULL, mediaMagnet VARCHAR(255) NOT NULL, entryDate TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, mediaSize DECIMAL, currentSize DECIMAL, status TINYINT(4))";
